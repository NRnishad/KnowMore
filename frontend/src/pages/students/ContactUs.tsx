  ...
  return (
    <div className="w-full ">
      ...
      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
        At <strong>KnowMore</strong>, your feedback, questions, and suggestions are valuable to us. Whether you're 
      ...
      <ul className="space-y-2 mb-6">
        <li>
          <strong>Email:</strong> <a href="#" className="text-blue-600">support@KnowMore.com</a>
        </li>
        <li>
