  ...
  return (
    ...
    <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-100 mb-6">About Us</h1>
      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
        Welcome to <strong>KnowMore</strong>, where we redefine the way people learn, teach, and grow. Our platform 
      ...
      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
        At <strong>KnowMore</strong>, our mission is to empower individuals by providing access to world-class education 
      ...
      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
        <strong>KnowMore</strong> was founded in [Year] with the goal of transforming education through innovation. 
      ...
      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
        ...
        <strong>KnowMore</strong> is the place for you. Together, let’s shape the future of education and make 
        knowledge a resource for all.
      </p>

      <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        Thank you for choosing <strong>KnowMore</strong>. Let’s build a better tomorrow, one lesson at a time.
      </p>
      </div>
    </div>
  );
